 ...
 */
@WebServlet(name = "CadastroCurriculo", urlPatterns = {"/CadastroCurriculo"})
public class CadastroCurriculo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Servlet CadastroCurriculo</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Cadastro Curriculo</h1>");
        ...
        out.println("<p>Curriculo: " + texto + " </p>");
